...
#reads in files
fec_files <- c("golden-year-end.csv","brakey-year-end.csv","crafts-year-end.csv","bennett-year-end.csv")
...
sheets_append(to_export,ss = "1OSWadCx2k8yoPtl7k6HbaGWhO33zZhYNlsCeH7Tarcc", sheet=1)
...
sheets_append(data.frame(pacs),ss = "1OSWadCx2k8yoPtl7k6HbaGWhO33zZhYNlsCeH7Tarcc", sheet=2)
