...
## file lists
# list the files you are working with here
...
# or fec files <- c("golden-year-end.csv","brakey-year-end.csv","crafts-year-end.csv","bennett-year-end.csv")
## export to
google_sheet <- "1AHyU29SfGeXtHhiLsoWrHrXELqj4uT6DqfCzi7x81M8" # see documention for googlesheets4 via tidyverse

```

## Extracting Topline Info

```{r topline, echo=FALSE}
topline_data <- function(fec_files){
...
sheets_append(to_export,ss = google_sheet, sheet=1)
...
sheets_append(data.frame(pacs),ss = google_sheet, sheet=2)
